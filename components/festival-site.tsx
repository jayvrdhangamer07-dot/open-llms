...
const committee = [['Rajesh Patil', 'President', 'RP'], ['Minal Shah', 'Vice President', 'MS'], ['Vivek More', 'Secretary', 'VM'], ['Anita Jadhav', 'Treasurer', 'AJ']]
